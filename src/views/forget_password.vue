...
<!--   
      ...
      <div id="formContent">
        ...
        <form >
          <input type="text" id="login" class="fadeIn second"  placeholder="token" v-model="tok">
          <input type="text" id="login" class="fadeIn second"  placeholder="email" v-model="email">
        ...
        <button type="button" @click="login" class="btn btn-light btn-lg text-blue">changer mot de passe</button>
